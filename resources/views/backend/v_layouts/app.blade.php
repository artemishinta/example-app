                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waveseffect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{ route('anggota.index') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hidemenu">CRUD Anggota </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{ '/helloworld' }}" class="sidebar-link"><i
                                            class="mdi mdi-chevron-right"></i><span class="hide-menu"> Hello World
                                        </span></a>
                                </li>
                        </li>
                        <li class="sidebar-item"><a href="{{ 'ambilfile' }}" class="sidebar-link"><i
                                    class="mdi mdi-chevron-right"></i><span class="hide-menu"> Ambilfile </span></a>
                        </li>
                        <li class="sidebar-item"><a href="{{ 'getlorem' }}" class="sidebar-link"><i
                                    class="mdi mdi-chevron-right"></i><span class="hide-menu"> Getlorem </span></a>
                        </li>
                        </li>
                        <li class="sidebar-item"><a href="{{ 'getTabel' }}" class="sidebar-link"><i
                                    class="mdi mdi-chevron-right"></i><span class="hide-menu"> GetTabel </span></a>
                        </li>
                        </li>
                        <li class="sidebar-item"><a href="{{ 'getForm' }}" class="sidebar-link"><i
                                    class="mdi mdi-chevron-right"></i><span class="hide-menu"> GetForm </span></a>
                        </li>
                        </li>
